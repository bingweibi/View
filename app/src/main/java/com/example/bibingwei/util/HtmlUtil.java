...
public class HtmlUtil {
     ...
     * 生成完整的HTML文档
     *
     * @param storyDetail StoryDetail
     * @return String
     */
    public static String createHtmlData(ZhiHuDetail storyDetail) {
        final String css = HtmlUtil.createCssTag(storyDetail.getCss());
        final String js = HtmlUtil.createJsTag( storyDetail.getJs());
        final String body = handleHtml(storyDetail.getBody()).toString();
